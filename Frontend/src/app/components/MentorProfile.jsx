...
export function MentorProfile({ mentor, onBack, onBookDemo, isOwnProfile }) {
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                {isEditing && (
                                    <button className="px-8 py-4 rounded-2xl border-2 border-dashed border-border hover:border-primary/50 text-muted-foreground hover:text-primary font-black uppercase tracking-widest text-sm transition-all shadow-sm">
                                        + Add Skill
                                    </button>
                                )}
                            </div>
                                    ...
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <div className="p-5 rounded-2xl bg-muted/40 dark:bg-white/5 border border-border dark:border-white/5 shadow-sm flex items-center justify-between">
                                                ...
                                                {isEditing ? (
                                                    <select className="bg-background border border-border rounded-lg px-2 py-1.5 text-sm font-black outline-none shadow-sm">
                                                        <option>None</option>
                                                        <option>5 min</option>
